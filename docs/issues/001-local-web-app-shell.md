...
Create the first local web app shell for ResumeAgent using the approved Premium Career Command Center direction. The app should provide persistent navigation for Dashboard, Job Queue, Resume Review, Application Flow, Tracker, Portals, and Settings.

The shell should run locally and make the product feel like a real workspace instead of a command-line-only tool. It does not need full data integration yet, but the layout, routing, empty states, and design tokens should be ready for the rest of the implementation.
